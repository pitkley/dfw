...
* A bump in the minimum supported Rust version (MSRV), which for DFW currently is 1.57.0, will be done in minor version updates (i.e. they do not require a major version bump).
